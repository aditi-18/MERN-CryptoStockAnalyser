...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "1ccc62820b02a108d7e3";
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../src/routes.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
async function render(req, res) {
  const activeRoute = !(function webpackMissingModule() { var e = new Error("Cannot find module '../src/routes.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).find(route => Object(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["matchPath"])(req.path, route));
  let initialData;
...
function Contents() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Switch"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Redirect"], {
    ...
    from: "/",
    to: "/issues"
  }), !(function webpackMissingModule() { var e = new Error("Cannot find module './routes.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).map(attrs => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], _extends({}, attrs, {
    key: attrs.path
  }))));
}
